      ...
      >
        ...
        >
          <div class="p-4">
            ...
            <p class="text-p mb-4 text-sm">Modal opened via hover trigger (1.5s).</p>
...
const startHover = () => {
  console.log('Hover started, setting timeout')
  hoverTimeout = setTimeout(() => {
    console.log('Hover trigger activated after 1.5s')
    isOpen.value = true
  }, 1500)
}

const cancelHover = () => {
  console.log('Hover canceled, clearing timeout')
  if (hoverTimeout) {
